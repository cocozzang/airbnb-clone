...
export default function Modal({
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex select-none items-center justify-center overflow-y-auto overflow-x-hidden bg-neutral-800/70 outline-none focus:outline-none">
